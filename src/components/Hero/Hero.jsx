  ...
  return (
    <section className="hero-container">
        <div className="hero-content">
            ...
            <a href="https://drive.google.com/file/d/1mtzmM5qlI7vzipgB8mz2rb_D6tfeVylq/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="hire-me-button">My Resume</a>
        </div>
